...
const OfferTimer = () => {
  ...
  return (
    <div
      ...
      className={`fixed left-0 top-1/4 -translate-y-1/2 bg-rojo text-white rounded-r-lg shadow-lg z-40 transition-transform duration-300 ease-in-out cursor-pointer ${
